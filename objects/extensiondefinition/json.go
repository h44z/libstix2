...
*/
func Decode(data []byte) (*ExtensionDefinition, error) {
...
*/
func (o *ExtensionDefinition) UnmarshalJSON(b []byte) error {
...
*/
func (o *ExtensionDefinition) Encode() ([]byte, error) {
...
JSON
*/
func (o *ExtensionDefinition) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
